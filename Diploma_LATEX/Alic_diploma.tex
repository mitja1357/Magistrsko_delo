...
\section{Napaka pri stati"cni ekscentri"cnosti v smeri x-osi}
...
Iz slike \ref{fig:protokol_xs_1} se vidi napaka v obliki enosmerne komponente in drugega harminika na periodo. Napaka se s konstantnim vrtenjem magneta ne akumulira, zato je dovolj prikaz napake na eni periodi. Napako razvijem v Fouriejevo vrsto do osmega harmonika. Amplitude posameznega harmonika za staticno ekscentri"cnost v smeri x osi za izmik $0,1$~mm so prikazane na sliki \ref{fig:vrsta_protokola_xs_1}.

\begin{figure}

	\includegraphics{\dirslike/vrsta_protokola_xs_1}
...
\begin{figure}
	...
	\includegraphics{\dirslike/vrsta_protokola_ys_1}
	\caption{AAmplitude harmonikov protokola}
...
\begin{figure}
	...
	\includegraphics{\dirslike/vrsta_protokola_xd_1}
	\caption{AAmplitude harmonikov protokola}
...
\begin{align*}
a_1& =-6.306319442659312 \cdot 10^{-4}\\
a_2& =-1.640168709495793 \cdot 10^{-3}\\
a_3& = 3.962017072440235 \cdot 10^{-3}\\
a_4& =-2.887048260782111 \cdot 10^{-4}\\
a_5& =-1.412276545356571 \cdot 10^{-1}\\
a_6& =-7.931822230064153 \cdot 10^{-3}\\
a_7& =-2.104555700820865 \cdot 10^{-2}\\
a_8& = 6.238774627110503 \cdot 10^{-4}\\
a_9& = 7.651613620676274 \cdot 10^{-1}\\
a_{10}& =4.980440898351878 \cdot 10^{-3}
\end{align*}
...
\label{eq:brez_eks} 
\begin{split}
\varphi=0.00498044 + 0.00229295 r_0^2\\
-( 0.00793182 r_0 +0.00054515 r_0^3) \cos(\theta)\\
+ 0.00166907 r_0^2 \cos(2 \theta)\\
-0.0000854818 r_0^3 \cos(3 \theta)\\
+(0.765161 r_0- 0.0161942 r_0^3) \sin(\theta)\\
-0.0706138 r_0^2 \sin(2 \theta)\\
+ 0.00485135 r_0^3 \sin(3 \theta)\\
 \end{split}
 \end{equation}
 ...
 \begin{equation}
 \varphi=0.018 + 0.613\cdot \sin( \theta-2.484^\circ) - 
 0.407\cdot\sin(2\cdot\theta+1.354^\circ) -0.067\cdot\sin(3 \cdot\theta-1.009^\circ)
 \end{equation}
...
\begin{split}
\varphi=
0.00498044 + 0.00229295 r_0^2 - 0.0666518 r_0 x_s -0.0683209 x_s^2\\
 + (-0.00054515 r_0^3 + 0.75723 x_s -0.0185054 r_0^2 x_s \\- 0.0177038 x_s^3 
+r_0 (-0.00793182 - 0.0040957 x_s^2)) \cos[\theta]\\
 + (0.00166907 r_0^2 - 0.0666518 r_0 x_s - 0.0683209 x_s^2) \cos[2 \theta] \\
+(-0.0000854818 r_0^3 + 0.0149733 r_0^2 x_s - 
0.00136523 r_0 x_s^2 - 0.00590127 x_s^3) \cos[3 \theta] \\
+r_0 (0.765161 - 0.0161942 r_0^2 - 0.000964437 r_0 x_s - 
0.0163386 x_s^2)\sin[\theta]\\
 + r_0(-0.070614 r_0 - 0.06999 x_s)  \sin[2\theta]\\
+r_0 (0.00485135 r_0^2 - 0.000964437 r_0 x_s - 0.0163386 x_s^2) \sin[3 \theta]
\end{split}
\end{equation}
...
\begin{split}
\varphi=
0.00498044 + 0.00229295 r_0^2 - 0.0699899 r_0 y_s - 
0.0683209 y_s^2 \\
+r_0  (-0.00793182 - 0.00054515 r_0^2 - 0.000964437 r_0 y_s - 
0.00136523 y_s^2 )\cos(\theta)\\
+ (0.00166907 r_0^2 + 0.0699899 r_0 y_s + 
0.0683209 y_s^2) \cos(2 \theta)\\
+(- 0.0000854818 r_0^3 + 
0.000964437 r_0^2 y_s + 0.00136523 r_0 y_s^2) \cos(3 \theta)\\
+(0.765161 r_0  - 0.0161942 r_0^3+0.75723 y_s  - 0.048452 r_0^2 y_s\\
 -0.0490157 r_0 y_s^2  - 0.0177038 y_s^3) \sin(\theta)\\
+r_0  (-0.070614 r_0 - 0.066652 y_s) \sin(2 \theta)\\
+(0.00485135 r_0^3 + 0.0149733 r_0^2 y_s  + 
0.0163386 r_0 y_s^2  + 0.00590127 y_s^3 )\sin(3 \theta)\\
\end{split}
\end{equation}
...
\begin{split}
\varphi=
0.00498044 + 0.00229295 r_0^2 - 0.75723 x_d\\
 + 0.0334787 r_0^2 x_d - 0.136642 x_d^2 + 0.0236051 x_d^3\\ 
+(- 0.00793182 r_0
- 0.00054515 r_0^3  + 0.133304 r_0 x_d 
- 0.00546094 r_0 x_d^2) \cos(\theta)\\
 + (0.00166907 r_0^2  
- 0.0299467 r_0^2 x_d) \cos(2 \theta)\\
 - 0.0000854818 r_0^3 \cos(3 \theta)\\
+ (0.765161 r_0  - 0.0161942 r_0^3 
+ 0.13998 r_0 x_d - 0.0653542 r_0 x_d^2) \sin(\theta) \\
+(- 0.0706138 r0^2  + 0.00192887 r_0^2 x_d) \sin(2 \theta)\\ 
+ 0.00485135 r_0^3 \sin(3 \theta)
\end{split}
\end{equation}
