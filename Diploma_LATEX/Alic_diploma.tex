...
\begin{figure}[h!]
	...
	\includegraphics{\dirslike/protokol_real_xs_1}%vrednost_polja_real.m
	\caption{Napaka pomerjenega kota pri statiècni ekscentriènosti v smeri x-osi }
	\label{fig:protokol_real_xs}
\end{figure}

Z razvojem napake v Fourijejevo vrsto (slika \ref{fig:amplitude_real_xs}) lahko vidimo podobnosti, z napako, kjer je bilo uporabljeno linearno polje vektorja B. Vi"sjim harmonikom je amplituda ostala enaka ali se je zmanj"sala. Amplituda prve komponente se je tudi pove"cala vendar ne tako veliko kot amplituda enosmerne komponente in drugega harmonika.


\begin{figure}[h!]
	
	\includegraphics{\dirslike/vrsta_protokola_real_xs_1}%vrednost_polja_real.m
...
Rezultate pri simulaciji napake stati"cne ekscentri"cnosti v smeri y-osi, sem pri"cakoval podobne kot rezultate simulirane v smeri x-osi. Napaka $\varepsilon$ za primer ekscentri"cnosti v smeri y-osi, je prikazana na sliki \ref{fig:protokol_real_ys}. S slike se vidi negativno enosmerno komponento in izrazit drugi harmonik. 

\begin{figure}[h!]
	
	\includegraphics{\dirslike/protokol_real_ys_1}%vrednost_polja_real.m
...
\begin{figure}[h!]
	...
	\includegraphics{\dirslike/vrsta_protokola_real_ys_1}%vrednost_polja_real.m
...
\begin{figure}[h!]
	...
	\includegraphics{\dirslike/protokol_real_xd_1}%vrednost_polja_real.m
...
\begin{figure}[h!]
	...
	\includegraphics{\dirslike/protokol_real_yd_1}%vrednost_polja_real.m
