...
\begin{equation}
C_0(\Delta x_s)=40,4 \Delta x_s^3-13,41 \Delta x_s^2 +13,12 \Delta x_s+0.1253
\end{equation}

\begin{equation}
C_2(\Delta x_s)=-58,14 \Delta x_s^3+18,88 \Delta x_s^2 +10,54 \Delta x_s+0.003307
\end{equation}
...
Na sliki \ref{fig:potek_amplitude_harmonikov_ys_real} so predvidevanja potrdijo. Za"cetni vrednosti sta enaki. Amplituda drugega harmonika nara"sca
...
Predvidevam, da bo pri meritvah napaka ni"zja, v napaki se bo pokazala napaka v obliki enosmerne komponente oz. prvega ali drugega harmonika. Napaka bo z ve"canjem ekscentri"cnosti nara"s"cala.
