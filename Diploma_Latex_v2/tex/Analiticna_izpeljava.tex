...
Ob premiku senzorja ali magneta se spremni polje katerega pomerijo Hallove sonde.
...
Naj bo definiran kartezični koordinatni sistem, ki ima v izhodišču postavljen radialno polariziranim magnetom ($S_m(0, 0)$). V izhodišču se nahaja os vrtenja ($S_r(0, 0)$). Na poljubno točko $H(x_0,y_0)$, vendar ne v
...
\label{2_offseta}
Naj bo enosmerna komponenta v obeh signalih označena s $C_0$, kjer velja $C_0= A_0= B_0$.
