...
\slikaeps{$\varepsilon$ ob k 1.1 }{./Napake/napaka_amp11}
...
\slikaeps{$\varepsilon$ ob $b_0$ 0,1 }{./Napake/napaka_sin01}
...
\slikaeps{$\varepsilon$ ob $a_0$ 0,1 }{./Napake/napaka_cos01}
...
\slikaeps{$\varepsilon$ ob $c_0$ 0,1 }{./Napake/napaka_sincos01}
...
\slikaeps{$\varepsilon$ ob $\varphi_{sin} = 1^\circ$ }{./Napake/napaka_fazasin1}
...
\slikaeps{$\varepsilon$ ob $\varphi_{cos} = 1^\circ$ }{./Napake/napaka_fazacos1}
