...
\slikaeps{$sin$ in $cos$ brez ekscentričnosti}{./LIN/yd_sincos}
...
\slikaeps{$sin$ in $cos$ pri simulacijah z linearnim poljem pri 0,24 mm dinamične ekscentričnosti v smeri x}{./LIN/xd_sincos}
