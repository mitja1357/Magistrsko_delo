...
\slikaeps{Potek signalov $sin$ in $cos$ brez ekscentričnosti}{./LIN/lin_00_sincos}
\slikaeps{Napaka $\varepsilon$ pri simulacijah z linearnim magnetnim poljem brez ekscentričnosti}{./LIN/lin_00_napaka}
...
\slikaeps{Amplituda osnovnega harmonika signalov $sin$ in $cos$ pri simulacijah z linearnim poljem stati"cne ekscentri"cnosti v smeri x}{./LIN/lin_xs_sincos_amp}
