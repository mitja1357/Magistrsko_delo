...
V napaki prevladuje prvi harmonik kar je vidno tudi iz razvoja v Fourierovo vrsto (Slika \ref{./LIN/xd_fft})

\slikaeps{Amplitude harmonikov napake $\varepsilon$ razvite v Fourierovo vrsto pri simulacijah z linearnim poljem pri 0,24 mm dinami"cne ekscentri"cnosti v smeri x}{./LIN/xd_fft}
...
Na sliki \ref{./LIN/xd_potek} vidimo odvisnost amplitud od spreminjanja ekscentri"cnosti.
