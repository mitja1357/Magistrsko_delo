...
\slikaeps{Signala $sin$ in $cos$ pomerjena v izhodi"s"cni legi}{./meritve/00_sincos}


Pomerjene napaka $\varepsilon$, je prikazana na sliki \ref{./meritve/00_napaka}.
\slikaeps{Napaka $\varepsilon$ pomerjena v izhodi"s"cni legi}{./meritve/00_napaka}
...
\slikaeps{Amplitude harmonikov napake $\varepsilon$ razvite v Fourierovo vrsto pri meritvah v izhodiščni legi}{./meritve/00_fft}
...
\slikaeps{Signala $sin$ in $cos$ merjena pri 0,25 mm statične ekscentičnosti v smeri x}{./meritve/xs_sincos}

\slikaeps{Napaka $\varepsilon$ merjena pri 0,25 mm statične ekscentičnosti v smeri x}{./meritve/xs_napaka}

\slikaeps{Amplitude harmonikov napake $\varepsilon$ razvite v Fourierovo vrsto merjeno pri 0,25 mm statične ekscentičnosti v smeri x}{./meritve/xs_fft}


\slikaeps{Signala $sin$ in $cos$ merjena pri 0,25 mm statične ekscentičnosti v smeri y}{./meritve/ys_sincos}

\slikaeps{Napaka $\varepsilon$ merjena pri 0,25 mm statične ekscentičnosti v smeri y}{./meritve/ys_napaka}

\slikaeps{Amplitude harmonikov napake $\varepsilon$ razvite v Fourierovo vrsto merjeno pri 0,25 mm statične ekscentičnosti v smeri y}{./meritve/ys_fft}
